...
//void WavDeassembler::GetWaveError(MMRESULT err) {
//    char errorMsg[256];
//    if (err == 0) {
//        return;
//    }else{
...
//void WavDeassembler::setPath(QString path) {
//    a=QString(path);
//    this->path=(LPTSTR)a.utf16();
////    this->path=path;
//}

//void WavDeassembler::setVolume(int volume) {
...
//void WavDeassembler::resume() {
//    mut.unlock();
//    waveOutRestart(hAudioOut);
//}

//void WavDeassembler::subThread(int bufferLoop) {
////    if (!mmioRead(hmmioIn, databuffer[bufferLoop].lpData, bufferSize)) {
////        qDebug() << "Error in reading the waveformat\n";
////        mmioClose(hmmioIn, 0);
////        exit(-1); //exit(-1);
...
////void SubThread::run() {
////#include <WavDeassembler.h>
////    if (!mmioRead(*WavDeassembler.hmmioIn, databuffer[bufferLoop].lpData, bufferSize)) {
////        qDebug() << "Error in reading the waveformat\n";
////        mmioClose(*WavDeassembler.hmmioIn, 0);
////        return; //exit(-1);
////    }
////    if (databuffer[bufferLoop].lpData == 0) {
////        break;
////    }
////    waveOutWrite(*WavDeassembler.hAudioOut, &databuffer[bufferLoop], sizeof(WAVEHDR));
////    Sleep(10000);
////    waveOutUnprepareHeader(*WavDeassembler.hAudioOut, &databuffer[bufferLoop], sizeof(databuffer[bufferLoop]));
////    memset(databuffer[bufferLoop].lpData, 0, bufferSize);
////    err = waveOutPrepareHeader(*WavDeassembler.hAudioOut, &databuffer[bufferLoop], sizeof(WAVEHDR));
////}
